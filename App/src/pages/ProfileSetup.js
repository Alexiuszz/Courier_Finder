...
import { IconButton, TextArea } from '../Components/form_components/FormComponents';
            ...
            <div className="profileSetupWrapper">
                ...
                <div className="profileSetup">
                    <div className="logoSelect">
                        <div className="logo">
                            <img src={logo.src !== undefined ? logo.src : noLogo} alt="logo" className="logoImg" />
                        </div>
                        <input onChange={handlePictureSelected} type="file" name="file" id="file" className="inputFile" />
                        {/* eslint-disable-next-line jsx-a11y/img-redundant-alt */}
                        <label for="file">{fileName}<img src={imgSelect} alt="image select" /></label>
                ...
                <div className="setupBtns">
                    <IconButton text="Skip &gt;&gt;" handleSubmit={f => f} className='skipBtn' />
                    <IconButton text="Continue" handleSubmit={f => f} className='continueBtn' />
